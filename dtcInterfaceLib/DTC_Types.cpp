...
DTCLib::DTC_Timestamp::DTC_Timestamp() : timestamp_(0) {}

DTCLib::DTC_Timestamp::DTC_Timestamp(const uint64_t timestamp) : timestamp_(timestamp) {}
...
DTCLib::DTC_Timestamp::DTC_Timestamp(const std::bitset<48> timestamp) : timestamp_(timestamp.to_ullong()) {}
