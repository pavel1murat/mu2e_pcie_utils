...
function PopulateLEDS( dtcregdump ) {
    ...
    setPixel( document.getElementById( "SERDESRXDisparityCFOLowLED" ),dtcregdump.CFO.SERDESRXDisparity.Low,"RO" );
    setPixel( document.getElementById( "SERDESRXDisparityCFOHighLED" ),dtcregdump.CFO.SERDESRXDisparity.High,"RO" );
    ...
    setPixel( document.getElementById( "SERDESRXCNITCFOLowLED" ),dtcregdump.CFO.CharacterError.Low,"RO" );
    setPixel( document.getElementById( "SERDESRXCNITCFOHighLED" ),dtcregdump.CFO.CharacterError.High,"RO" );
    ...
    setPixel( document.getElementById( "SERDESUnlockCFOLED" ),dtcregdump.CFO.UnlockError,"RO" );
    ...
    setPixel( document.getElementById( "SERDESEyescanRing0LED" ),dtcregdump.Ring0.EyescanError,"RO" );
    setPixel( document.getElementById( "SERDESEyescanRing1LED" ),dtcregdump.Ring1.EyescanError,"RO" );
    setPixel( document.getElementById( "SERDESEyescanRing2LED" ),dtcregdump.Ring2.EyescanError,"RO" );
    setPixel( document.getElementById( "SERDESEyescanRing3LED" ),dtcregdump.Ring3.EyescanError,"RO" );
    setPixel( document.getElementById( "SERDESEyescanRing4LED" ),dtcregdump.Ring4.EyescanError,"RO" );
    setPixel( document.getElementById( "SERDESEyescanRing5LED" ),dtcregdump.Ring5.EyescanError,"RO" );
    setPixel( document.getElementById( "SERDESEyescanCFOLED" ),dtcregdump.CFO.EyescanError,"RO" );
